...
var OptionsTree = [
	...
	{name:'Add or remove pins'}
];
</script>
</head>
<body class="FlyUiText FlyUiNoSelect">

<div class="FlyCSTitle">Add or remove pins from the Jump menu</div>
<p class="FlyCSDescription">Customizing your Jump pins can now be done directly from the menu itself!</p>
