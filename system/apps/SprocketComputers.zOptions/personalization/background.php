...
<div class="box"><div style="margin:0 auto;width:320px;height:180px;background-image:url('<?php echo FlyVarsReplace((string)$_FLY_USER->visual->theme->backgroundImage,true); ?>');background-size:cover;background-position:center center;"></div></div>
