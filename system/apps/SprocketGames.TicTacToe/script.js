var o = FLY_ICONS_URL."mark-x.svg";
// Location of where you uploaded your site's x image

var x = FLY_ICONS_URL."mark-o.svg";
...
var ts = 0;
function help() {
	window.top.shell.dialog("Welcome to Tic-Tac-Toe!", "You play as the O's and the computer is the X's.  Select the square you want to put your O into by clicking them.  You cannot occupy a square that is already occupied. The first player to get three squares in a row wins.  Good Luck!","Tic-Tac-Toe","/tictactoe.svg");
}
function logicOne() {
...
function process() {
logicOne();
if (all==1){ window.top.alert("You won, congratulations!"); wn++; }
if (all==2){ window.top.alert("Gotcha!  I win!"); ls++; }
if (all==3){ window.top.alert("We tied."); ts++; }
if (all!=0) {
